...
public final class CpanHandler extends BaseArtifactHandler {
    ...
    protected @NotNull BaseMemento doBegin(
        ...
        throw new UnsupportedOperationException("Not yet implemented: CpanHandler.doBegin");
    }

    @Override
    protected @NotNull List<Purl> doBuildPurls(@NotNull BaseMemento memento) {
        throw new UnsupportedOperationException("Not yet implemented: CpanHandler.doBuildPurls");
    }
}
