...
public final class CondaHandler extends BaseArtifactHandler {
    ...
    protected @NotNull BaseMemento doBegin(
        ...
        throw new UnsupportedOperationException("Not yet implemented: CondaHandler.doBegin");
    }

    @Override
    protected @NotNull List<Purl> doBuildPurls(@NotNull BaseMemento memento) {
        throw new UnsupportedOperationException("Not yet implemented: CondaHandler.doBuildPurls");
    }
}
