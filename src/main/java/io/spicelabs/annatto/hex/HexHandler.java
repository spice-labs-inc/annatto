...
public final class HexHandler extends BaseArtifactHandler {
    ...
    protected @NotNull BaseMemento doBegin(
        ...
        throw new UnsupportedOperationException("Not yet implemented: HexHandler.doBegin");
    }

    @Override
    protected @NotNull List<Purl> doBuildPurls(@NotNull BaseMemento memento) {
        throw new UnsupportedOperationException("Not yet implemented: HexHandler.doBuildPurls");
    }
}
