...
/**
 * Memento capturing extracted state from a CocoaPods podspec.json.
 * Stores the raw JSON text for diagnostics.
 *
 * <p>Created during {@link CocoapodsHandler#doBegin} and not shared across threads.</p>
 */
public final class CocoapodsMemento extends BaseMemento {

    private final String rawJson;

    /**
     * Creates a memento for a successfully extracted CocoaPods package.
     *
     * @param artifactFilename the filename of the artifact being processed
     * @param rawJson          the raw podspec.json content
     */
    public CocoapodsMemento(@NotNull String artifactFilename, @NotNull String rawJson) {
        super(EcosystemId.COCOAPODS, artifactFilename);
     ...
     * @param artifactFilename the filename of the artifact being processed
     */
    public CocoapodsMemento(@NotNull String artifactFilename) {
        super(EcosystemId.COCOAPODS, artifactFilename);
        this.rawJson = "";
    }

    /** @return the raw podspec.json content */
