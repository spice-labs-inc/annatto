...
public final class CocoapodsHandler extends BaseArtifactHandler {
    ...
    protected @NotNull BaseMemento doBegin(
        ...
        throw new UnsupportedOperationException("Not yet implemented: CocoapodsHandler.doBegin");
    }

    @Override
    protected @NotNull List<Purl> doBuildPurls(@NotNull BaseMemento memento) {
        throw new UnsupportedOperationException("Not yet implemented: CocoapodsHandler.doBuildPurls");
    }
}
