 ...
 * gzip tar archives containing {@code Cargo.toml}).
 * (tested by {@code CratesMetadataExtractorTest.isCargoToml_standardEntry},
 * {@code AnnattoProcessFilterTest.detectEcosystem_crate_isCrates})
 * Uses a two-step extraction pattern:</p>
 * <ol>
 ...
 * </ol>
 * <p>(pipeline tested by 9 parameterized SoT tests in {@code CratesMetadataExtractorTest.extract*_matchesSourceOfTruth})</p>
 *
