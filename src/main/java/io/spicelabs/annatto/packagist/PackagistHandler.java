...
public final class PackagistHandler extends BaseArtifactHandler {
    ...
    protected @NotNull BaseMemento doBegin(
        ...
        throw new UnsupportedOperationException("Not yet implemented: PackagistHandler.doBegin");
    }

    @Override
    protected @NotNull List<Purl> doBuildPurls(@NotNull BaseMemento memento) {
        throw new UnsupportedOperationException("Not yet implemented: PackagistHandler.doBuildPurls");
    }
}
