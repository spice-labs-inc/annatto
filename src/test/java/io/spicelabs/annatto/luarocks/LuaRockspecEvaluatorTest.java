...
class LuaRockspecEvaluatorTest {
    ...
    /**
     * Test helper: evaluates valid test input, converting the checked
     * LuaParseException into an AssertionError (inputs here are never expected to fail).
     */
    private static Map<String, Object> ev(String source) {
        try {
            return LuaRockspecEvaluator.evaluate(source);
    ...
    void evaluate_simpleRockspec() {
        ...
        Map<String, Object> result = ev(source);
